...
namespace ProductAPI.Services
{
    public class ProductService
    {
        private SqlConnection GetConnection()
        {
            ...
            string connectionString = "Server=tcp:authappdbserver.database.windows.net,1433;Initial Catalog=authappdb;Persist Security Info=False;User ID=vishgmail;Password=Es@1506@pN;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
